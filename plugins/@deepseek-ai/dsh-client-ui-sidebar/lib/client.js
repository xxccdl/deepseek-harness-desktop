window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		var SidebarRoot_module_css_default = {
			...
			"brand": "hHd-Xa_brand",
			"desktopBadge": "hHd-Xa_desktopBadge",
