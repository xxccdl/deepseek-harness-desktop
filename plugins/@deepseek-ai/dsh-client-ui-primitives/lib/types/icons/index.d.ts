...
/** Added by the desktop fork: tool-family glyph on the shared 1.5px stroke language. */
export declare const IconCursorOutline16: ({ size, className }: IconProps) => import("react").JSX.Element;
/** Added by the desktop fork: tool-family glyph on the shared 1.5px stroke language. */
export declare const IconEyeOutline16: ({ size, className }: IconProps) => import("react").JSX.Element;
/** Added by the desktop fork: tool-family glyph on the shared 1.5px stroke language. */
export declare const IconBrowserOutline16: ({ size, className }: IconProps) => import("react").JSX.Element;
/** Added by the desktop fork: tool-family glyph on the shared 1.5px stroke language. */
export declare const IconDeviceOutline16: ({ size, className }: IconProps) => import("react").JSX.Element;
/** Added by the desktop fork: tool-family glyph on the shared 1.5px stroke language. */
export declare const IconServerOutline16: ({ size, className }: IconProps) => import("react").JSX.Element;
